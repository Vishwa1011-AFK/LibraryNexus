...
import { User, Mail, Lock, Key, Calendar } from "lucide-react"
        ...
        try {
            await apiClient('/auth/signup', 'POST', payload)
             ...
             try {
                 ...
                 setErrors({ form: `Account created, but failed to send verification email: ${otpError.message}. Please try logging in or contact support.` })
            ...
            <Card className="border-border">
                ...
                <div className="space-y-4">
                    ...
                    <FormField
                        ...
                        placeholder="Enter your email (@iiitm.ac.in)"
                        error={errors.email}
